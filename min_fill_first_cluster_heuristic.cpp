...
Min_Fill_First_Cluster_Heuristic::Min_Fill_First_Cluster_Heuristic (Light_Graph * gs)
...
pair<int,vertex *> Min_Fill_First_Cluster_Heuristic::Choose ()
{
  Light_Graph * pg = g;
...
Cluster_Node * Min_Fill_First_Cluster_Heuristic::Choose (bool is_available[])
